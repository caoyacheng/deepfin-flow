...
export const getBrandConfig = (): BrandConfig => {
  return {
    ...
    primaryColor:
      getEnv("NEXT_PUBLIC_BRAND_PRIMARY_COLOR") || defaultConfig.primaryColor,
    secondaryColor:
      getEnv("NEXT_PUBLIC_BRAND_SECONDARY_COLOR") ||
      defaultConfig.secondaryColor,
    accentColor:
      getEnv("NEXT_PUBLIC_BRAND_ACCENT_COLOR") || defaultConfig.accentColor,
    customCssUrl:
      getEnv("NEXT_PUBLIC_CUSTOM_CSS_URL") || defaultConfig.customCssUrl,
    hideBranding: getEnv("NEXT_PUBLIC_HIDE_BRANDING") === "true",
    footerText:
      getEnv("NEXT_PUBLIC_CUSTOM_FOOTER_TEXT") || defaultConfig.footerText,
    supportEmail:
