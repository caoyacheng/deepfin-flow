...
export const env = createEnv({
  ...
  server: {
    ...
    OPENROUTER_API_KEY: z.string().min(1).optional(), // OpenRouter API key for unified AI model access
    ...
    // Aliyun DashScope API Keys (for Qwen models)
    DASHSCOPE_API_KEY: z.string().min(1).optional(), // Aliyun DashScope API key for Qwen models
    ...
    OSS_REGION: z.string().optional(), // Aliyun OSS region
    OSS_ACCESS_KEY_ID: z.string().optional(), // Aliyun OSS access key ID
    OSS_ACCESS_KEY_SECRET: z.string().optional(), // Aliyun OSS access key secret
    OSS_BUCKET_NAME: z.string().optional(), // OSS bucket for general file storage
    OSS_ENDPOINT: z.string().optional(), // OSS endpoint (optional, auto-generated if not provided)
    OSS_KB_BUCKET_NAME: z.string().optional(), // OSS bucket for knowledge base files
    OSS_EXECUTION_FILES_BUCKET_NAME: z.string().optional(), // OSS bucket for workflow execution files
    OSS_CHAT_BUCKET_NAME: z.string().optional(), // OSS bucket for chat logos
    OSS_COPILOT_BUCKET_NAME: z.string().optional(), // OSS bucket for copilot files
