    ...
    if (searchParams) {
      ...
      if (callback) {
        ...
        if (validateCallbackUrl(callback)) {
          ...
          logger.warn("Invalid callback URL detected and blocked:", {
            url: callback,
          });
  ...
  return (
    <div className="space-y-6">
      <div className="space-y-2 text-center">
        ...
        <p className="text-neutral-400 text-sm">请输入您的邮箱登录</p>
      </div>
      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="text-center text-sm">
          <span className="text-neutral-400">还没有账号? </span>
          <Link
            href={
              isInviteFlow
