...
const blockConfig = {
  ...
  slack: {
    icon: MessagesIcon, // Assuming custom SlackIcon
    color: "#2563eb", // Slack-like color (adjust if needed)
    name: "消息",
  },
};
...
export const HeroBlock = memo(({ id, data }: NodeProps) => {
  ...
  const showInputHandle =
    type !== "start" &&
    !(type === "function" && id === "function1" && data.isHeroSection);
    ...
    <div className="group relative flex flex-col items-center opacity-90">
      ...
      <BlockCard Icon={Icon} iconBgColor={iconBgColor} title={nodeName}>
        ...
        <div className="space-y-3 pt-3 text-sm">
          ...
          {type === "start" && (
            <>
              <div className="font-medium text-[#7D7D7D] text-base">
                开始工作流
              </div>
              <Container>
                <p>手动运行</p>
          ...
          {type === "agent" && (
            <div className="flex flex-col gap-4">
              <div className="flex flex-col gap-2">
                <p className="font-medium text-[#7D7D7D] text-base">智能体</p>
                <Container>输入系统提示</Container>
              </div>
              <div className="flex flex-col gap-2">
                <p className="font-medium text-[#7D7D7D] text-base">用户提示</p>
                <Container>输入上下文</Container>
              </div>
              <div className="flex w-full gap-3">
                <div className="flex w-full flex-col gap-2">
                  <p className="font-medium text-[#7D7D7D] text-base">模型</p>
                  <Container>
                    <p>DeepSeek</p>
                    <ChevronDown size={14} />
                  </Container>
                ...
                <div className="flex w-full flex-col gap-2">
                  <p className="font-medium text-[#7D7D7D] text-base">工具</p>
          ...
          {type === "router" && (
            <div className="flex flex-col gap-4">
              <div className="flex flex-col gap-2">
                <p className="font-medium text-[#7D7D7D] text-base">提示</p>
                <Container className="min-h-32 items-start">输入提示</Container>
              </div>
              <div className="flex flex-col gap-2">
                <p className="font-medium text-[#7D7D7D] text-base">模型</p>
                <Container>
          ...
          {type === "slack" && (
            <div className="flex flex-col gap-4">
              <div className="flex flex-col gap-2">
                <p className="font-medium text-[#7D7D7D] text-base">频道</p>
                <Container>输入消息频道 (#general)</Container>
              </div>
              <div className="flex flex-col gap-2">
                <p className="font-medium text-[#7D7D7D] text-base">消息</p>
