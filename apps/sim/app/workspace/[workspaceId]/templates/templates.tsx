...
export default function Templates({
  ...
  const yourTemplatesCount = templates.filter(
    (template) =>
      template.userId === currentUserId || template.isStarred === true
  ).length;
  ...
  const getTemplatesByCategory = (
    category: CategoryValue | "your" | "recent"
  ) => {
  ...
  const navigationTabs = [
    ...
    },
    {
      ...
      count: loading
        ? 8
        : getTemplatesByCategory("artificial-intelligence").length,
    },
    {
      id: "other",
      label: "其他",
        ...
        <div className="flex flex-1 flex-col overflow-auto p-6">
          ...
          <div ref={sectionRefs["artificial-intelligence"]} className="mb-8">
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
              {loading
                ? renderSkeletonCards()
                : getTemplatesByCategory("artificial-intelligence").map(
