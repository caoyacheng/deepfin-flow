              ...
              >
                ...
                {workspace.permissions !== "admin" && (
                  <AlertDialog>
                    ...
                    <AlertDialogContent>
                      <AlertDialogHeader>
                        <AlertDialogTitle>退出工作区？</AlertDialogTitle>
                        <AlertDialogDescription>
                          退出此工作区将移除您对所有相关工作流程、日志和知识库的访问权限。{" "}
                      ...
                      <div className="py-2">
                        <p className="mb-2 font-[360] text-sm">
                          输入工作区名称 <strong>{workspace.name}</strong>{" "}
                          以确认退出。
                        </p>
                        <Input
                          value={leaveConfirmationName}
                          onChange={(e) =>
                            setLeaveConfirmationName(e.target.value)
                          }
                          placeholder="输入工作区名称"
                          className="h-9"
                        />
                      ...
                      <AlertDialogFooter className="flex">
                        ...
                        <AlertDialogAction
                          ...
                          disabled={
                            isLeaving ||
                            leaveConfirmationName !== workspace.name
                          }
                        >
                    ...
                    <AlertDialogContent>
                      ...
                      <AlertDialogFooter className="flex">
                        ...
                        <AlertDialogAction
                          ...
                          disabled={
                            isDeleting ||
                            deleteConfirmationName !== workspace.name
                          }
                        >
                          {isDeleting ? "删除中..." : "删除"}
                        </AlertDialogAction>
