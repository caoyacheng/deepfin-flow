...
try {
  ...
  throw error;
      ...
      placeholder: "描述要生成的 JavaScript 代码",
  ...
  const handleKeyDown = (e: React.KeyboardEvent) => {
    ...
    const isSchemaPromptVisible =
      activeSection === "schema" && schemaGeneration.isPromptVisible;
    const isCodePromptVisible =
      activeSection === "code" && codeGeneration.isPromptVisible;
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        const errorMessage =
          errorData.error || response.statusText || "Failed to delete tool";
      ...
      const errorMessage =
        error instanceof Error ? error.message : "Failed to delete custom tool";
        ...
        >
          <DialogHeader className="border-b px-6 py-4">
            ...
            <DialogDescription className="mt-1.5">
              ...
              {activeSection === "schema" ? "定义结构" : "实现代码"}
            </DialogDescription>
          </DialogHeader>
                ...
                <div className="mb-1 flex min-h-6 items-center justify-between">
                    ...
                    <Button
                      ...
                      onClick={() => {
                        ...
                        logger.debug(
                          ...
                          typeof schemaGeneration.showPromptInline ===
                            "function"
                        );
                  ...
                  {schemaError &&
                    !schemaGeneration.isStreaming && ( // Hide schema error while streaming
                      <span className="ml-4 flex-shrink-0 text-red-600 text-sm">
                        {schemaError}
                      </span>
                    )}
                </div>
  ...
  "function": {
    ...
    "parameters": {
      ...
      "required": ["itemName"]
                  ...
                  minHeight="360px"
                  className={cn(
                    schemaError && !schemaGeneration.isStreaming
                      ? "border-red-500"
                      : "",
                    (schemaGeneration.isLoading ||
                      schemaGeneration.isStreaming) &&
                  ...
                  } // Use disabled prop instead of readOnly
              ...
              >
                ...
                <div ref={codeEditorRef} className="relative">
                  <CodeEditor
                    ...
                    language="javascript"
                    placeholder={
                      "// 这个代码将在工具被调用时执行。你可以使用环境变量，例如 {{VARIABLE_NAME}}。"
                    }
                    minHeight="360px"
                    className={cn(
      ...
      <AlertDialog open={showDeleteConfirm} onOpenChange={setShowDeleteConfirm}>
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>确定要删除这个工具吗？</AlertDialogTitle>
            <AlertDialogDescription>
              这个操作无法撤销。这个工具将被永久删除，并从任何使用它的工作流中移除。
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
