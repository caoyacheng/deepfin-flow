...
export function Variables() {
  ...
  const workflowVariables = activeWorkflowId
  ...
  const getValidationStatus = (variable: Variable): string | undefined => {
    ...
    switch (variable.type) {
      case "number":
        return Number.isNaN(Number(variable.value))
          ? "不是一个有效数字"
          : undefined;
      case "boolean":
                ...
                <div className="flex items-center gap-2">
                  ...
                  <DropdownMenu>
                    ...
                    >
                      <DropdownMenuItem
                        onClick={() =>
                          updateVariable(variable.id, { type: "plain" })
                        }
                      ...
                      >
                        ...
                        <span className="font-[380]">字符串</span>
                      </DropdownMenuItem>
                      <DropdownMenuItem
                        onClick={() =>
                          updateVariable(variable.id, { type: "number" })
                        }
                        className="flex cursor-pointer items-center rounded-md px-3 py-2 font-[380] text-card-foreground text-sm hover:bg-secondary/50 focus:bg-secondary/50"
                      >
                        <div className="mr-2 w-5 text-center font-[380] text-sm">
                        ...
                        <span className="font-[380]">数字</span>
                      </DropdownMenuItem>
                      <DropdownMenuItem
                        onClick={() =>
                          updateVariable(variable.id, { type: "boolean" })
                        }
                        className="flex cursor-pointer items-center rounded-md px-3 py-2 font-[380] text-card-foreground text-sm hover:bg-secondary/50 focus:bg-secondary/50"
                      >
                        <div className="mr-2 w-5 text-center font-[380] text-sm">
                        ...
                        <span className="font-[380]">布尔值</span>
                      </DropdownMenuItem>
                      <DropdownMenuItem
                        onClick={() =>
                          updateVariable(variable.id, { type: "object" })
                        }
                        className="flex cursor-pointer items-center rounded-md px-3 py-2 font-[380] text-card-foreground text-sm hover:bg-secondary/50 focus:bg-secondary/50"
                      >
                        <div className="mr-2 w-5 text-center font-[380] text-sm">
                        ...
                        <span className="font-[380]">对象</span>
                      </DropdownMenuItem>
                      <DropdownMenuItem
                        onClick={() =>
                          updateVariable(variable.id, { type: "array" })
                        }
                        className="flex cursor-pointer items-center rounded-md px-3 py-2 font-[380] text-card-foreground text-sm hover:bg-secondary/50 focus:bg-secondary/50"
                      >
                        <div className="mr-2 w-5 text-center font-[380] text-sm">
                        ...
                        <span className="font-[380]">数组</span>
                      </DropdownMenuItem>
                    </DropdownMenuContent>
                  </DropdownMenu>
