    ...
    <div className="space-y-3">
      ...
      <div className="flex items-center gap-2">
        ...
        {hasInputData && (
          <>
            ...
            >
              <span className="font-normal text-xs leading-normal">输出</span>
            </button>
            <button
            ...
            >
              <span className="font-normal text-xs leading-normal">输入</span>
            </button>
      ...
      <div className="space-y-2 pb-2">
        ...
        {(showInput ? hasInputData : entry.output != null && !entry.error) && (
          <div
            className={`rounded-lg bg-secondary/50 ${shouldShowCodeDisplay ? "p-0" : "p-3"}`}
          >
            {shouldShowCodeDisplay ? (
